...
public final class OneHttpHeaders {
    private final String[] namesAndValues;

    OneHttpHeaders(Builder builder) {
        this.namesAndValues = builder.namesAndValues.toArray(new String[builder.namesAndValues.size()]);
    }

    private OneHttpHeaders(String[] namesAndValues) {
    ...
    public boolean equals(@Nullable Object other) {
        return other instanceof OneHttpHeaders
                && Arrays.equals(((OneHttpHeaders) other).namesAndValues, namesAndValues);
    }
     ...
     */
    public static OneHttpHeaders of(String... namesAndValues) {
        ...
        return new OneHttpHeaders(namesAndValues);
    }

    /**
     * Returns headers for the header names and values in the {@link Map}.
     */
    public static OneHttpHeaders of(Map<String, String> headers) {
    ...
    public static final class Builder {
         ...
         */
        public Builder addAll(OneHttpHeaders headers) {
        ...
        public OneHttpHeaders build() {
            return new OneHttpHeaders(this);
        }
    }
}
